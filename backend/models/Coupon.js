...
// Virtual to check if coupon is currently active
...
couponSchema.methods.canBeUsedByUser = async function (userId) {
  if (!this.isCurrentlyActive) return { canUse: false, reason: "Coupon is not active" };
